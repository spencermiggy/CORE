...
namespace CORE.View
{
    ...
    public partial class UpdatePage : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            try
            {
                var getprofile = (await MobileService.GetTable<customer>().Where(profile => profile.id == customer_id).ToListAsync()).FirstOrDefault();
                profgrid1.BindingContext = getprofile;
            }
            catch
            {
        ...
        private async void SaveBtn(object sender, EventArgs e)
        {
            ...
            if (firstname.Text == null || lastname.Text == null || Pnumb.Text == null || Addre.Text == null || Citys.Text == null || Passw.Text == null || SelectedImage.Source is null)
            {
